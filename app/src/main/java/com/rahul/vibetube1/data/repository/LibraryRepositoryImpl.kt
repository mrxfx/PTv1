...
class LibraryRepositoryImpl @Inject constructor(
    ...
    override suspend fun addVideoToLocalPlaylist(playlistId: Int, video: com.rahul.vibetube1.domain.model.VideoItem) {
    ...
    override suspend fun updateCachedFeed(key: String, videos: List<com.rahul.vibetube1.domain.model.VideoItem>) {
