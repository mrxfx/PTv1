...
import com.rahul.vibetube1.data.local.UserInterestEntity
...
interface LibraryRepository {
    ...
    // Blacklist
    fun getBlacklist(): Flow<List<com.rahul.vibetube1.data.local.BlacklistEntity>>
    suspend fun getBlacklistStatic(): List<com.rahul.vibetube1.data.local.BlacklistEntity>
    suspend fun addToBlacklist(id: String, type: com.rahul.vibetube1.data.local.BlacklistType)
    suspend fun removeFromBlacklist(id: String)
    suspend fun isBlacklisted(id: String): Boolean

    // Local Playlists
    fun getLocalPlaylists(): Flow<List<com.rahul.vibetube1.data.local.LocalPlaylistEntity>>
    suspend fun createLocalPlaylist(name: String, description: String? = null): Long
    suspend fun deleteLocalPlaylist(playlist: com.rahul.vibetube1.data.local.LocalPlaylistEntity)
    fun getVideosForLocalPlaylist(playlistId: Int): Flow<List<com.rahul.vibetube1.data.local.LocalPlaylistVideoEntity>>
    ...
    // Feed Cache
    fun getCachedFeed(key: String): Flow<com.rahul.vibetube1.data.local.FeedCacheEntity?>
