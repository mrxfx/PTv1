...
import com.rahul.vibetube1.ui.screens.library.GlobalGlassAlpha
...
fun DataManagementScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SettingsGroup(title = "ZyvoTube Native Backup") {
                    SettingsItem(
                        title = "Create Backup",
                        subtitle = "Save all your ZyvoTube data to a file",
                        icon = Icons.Default.Backup,
                        onClick = { backupCreator.launch("ZyvoTubeBackup_${System.currentTimeMillis()}.zip") }
                    )
                    HorizontalDivider(modifier = Modifier.padding(horizontal = 16.dp), thickness = 0.5.dp)
                    SettingsItem(
