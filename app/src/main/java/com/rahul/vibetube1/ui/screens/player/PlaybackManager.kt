...
class PlaybackManager @Inject constructor(
    ...
    private val _onSponsorSkipped = MutableSharedFlow<com.rahul.vibetube1.domain.model.SponsorSegment>()
    val onSponsorSkipped: SharedFlow<com.rahul.vibetube1.domain.model.SponsorSegment> = _onSponsorSkipped.asSharedFlow()
    ...
    private var sponsorSegments: List<com.rahul.vibetube1.domain.model.SponsorSegment> = emptyList()
    ...
    fun setSponsorSegments(segments: List<com.rahul.vibetube1.domain.model.SponsorSegment>) {
        sponsorSegments = segments
    }

    @OptIn(UnstableApi::class)
    fun prepareNextSource(video: com.rahul.vibetube1.domain.model.VideoItem, bundle: StreamBundle) {
    ...
    fun prepareNextLocalSource(video: com.rahul.vibetube1.domain.model.VideoItem, file: java.io.File) {
        if (player.mediaItemCount > 1) return
